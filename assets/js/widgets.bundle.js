...
var KTCardsWidget10 = function () {
    ...
    var initChart = function() {
        ...
        drawCircle(KTUtil.getCssVariableValue('--bs-success'), options.lineWidth, 100 / 150);
    ...
    var initMap = function () {
        ...
        var init = function() {
            ...
            polygonSeriesHighlighted.mapPolygons.template.set(
                "fill",
				am5.color(KTUtil.getCssVariableValue('--bs-success')),
            );

            polygonSeriesHighlighted.mapPolygons.template.states.create("hover", {
                fill: root.interfaceColors.get("successButtonHover"),
            });
...
var KTTimelineWidget24 = function () {
    ...
    var handleActions = function() {
        ...
        KTUtil.on(card, '[data-kt-element="follow"]', 'click', function (e) {
            if ( this.innerText === 'دنبال شده' ) {
                this.innerText ='دنبال کردن';
                this.classList.add('btn-light-success');
                this.classList.remove('btn-success');
                this.blur();
            } else {
                this.innerText = 'دنبال شده';
...
var KTSlidersWidget1 = function() {
    ...
    var initChart = function(chart, query, data) {
        ...
        var height = parseInt(KTUtil.css(element, 'height'));
        var baseColor = KTUtil.getCssVariableValue('--bs-' + 'success');
        var lightColor = KTUtil.getCssVariableValue('--bs-' + 'success-light' );         
    ...
    return {
        init: function () {
            ...
            carousel.addEventListener('slid.bs.carousel', function (e) {
                if (e.to === 1) {
                    // Init second chart
                    initChart(chart2, '#kt_sliders_widget_3_chart_2', 'success', data2);
                }                
            });
...
var KTTablesWidget3 = function () {
    ...
    const handleTabStates = () => {
        ...
        const tabClasses = ['border-bottom', 'border-3', 'border-success'];
...
var KTTablesWidget4 = function () {
    ...
    const populateTemplate = (data, target) => {
        data.forEach((d, index) => {
            ...
            const inStock = `<div class="badge badge-light-primary">In Stock</div>`;
    ...
    var handleCheckbox = function() {
        ...
        KTUtil.on(card, '[data-kt-element="checkbox"]', 'change', function (e) {
            ...
            if ( this.checked === true ) {
                check.classList.add('form-check-primary');
                ...
                check.classList.remove('form-check-primary');
...
var KTChartsWidget1 = function () {
    ...
    var initChart = function() {
        ...
        var negativeColor = element.hasAttribute('data-kt-negative-color') ? element.getAttribute('data-kt-negative-color') : KTUtil.getCssVariableValue('--bs-primary');
...
var KTChartsWidget10 = function () {
    ...
    var initChart = function(chart, toggle, chartSelector, data, initByDefault) {
        ...
        var options = {
            ...
            colors: [KTUtil.getCssVariableValue('--bs-success'), KTUtil.getCssVariableValue('--bs-success-light')],
            grid: {
                borderColor: borderColor,
                strokeDashArray: 4,
                yaxis: {
...
var KTChartsWidget13 = (function () {
    ...
    var initChart = function () {
        ...
        var init = function() {
            ...
            createSeries("Cars", "cars", KTUtil.getCssVariableValue('--bs-success'));
            createSeries("Motorcycles", "motorcycles", KTUtil.getCssVariableValue('--bs-primary'));
...
var KTChartsWidget17 = (function () {
    ...
    var initChart = function () {
        ...
        var init = function() {
            ...
            series.data.setAll([
                { value: 10, category: "One", fill: am5.color(KTUtil.getCssVariableValue('--bs-success')) },
                { value: 9, category: "Two", fill: am5.color(KTUtil.getCssVariableValue('--bs-primary')) },
		...
		var init = function() {
			...
			var series2 = chart.series.push(
				am5xy.LineSeries.new(root, {
					...
					categoryXField: "year",
					fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")),
					stroke: am5.color(KTUtil.getCssVariableValue("--bs-primary")),
					tooltip: am5.Tooltip.new(root, {
						pointerOrientation: "horizontal",
						labelText: "{name} in {categoryX}: {valueY} {info}",
					}),
			...
			series2.bullets.push(function () {
				return am5.Bullet.new(root, {
					sprite: am5.Circle.new(root, {
						...
						stroke: am5.color(KTUtil.getCssVariableValue("--bs-primary")),
						radius: 5,
						fill: am5.color(KTUtil.getCssVariableValue("--bs-primary-light")),
					}),
				});
			});
...
var KTChartsWidget36 = function () {
    ...
    var initChart = function(chart) {
        ...
        var options = {
            ...
            markers: {
                strokeColor: [basesuccessColor, baseprimaryColor],
                strokeWidth: 3
            }
        };
...
var KTChartsWidget9 = function () {
    ...
    var initChart = function() {
        ...
        var options = {
            ...
            markers: {
                colors: [baseColor, secondaryColor],
                strokeColor: [KTUtil.getCssVariableValue('--bs-success'), KTUtil.getCssVariableValue('--bs-gray-300')],
                strokeWidth: 3
            }
        };        
