...
var KTBlockUI = function(element, options) {
    ...
    var defaultOptions = {
        ...
        overlayClass: '',
        overflow: 'hidden',
        message: '<span class="spinner-border text-success"></span>'
    };
	...
	var handlePreview = function() {
		previewButton.addEventListener("click", function(e) {
			...
			$.ajax({
				...
				url: url,
				data: data,
				primary: function(response, status, xhr) {
		...
		resetButton.addEventListener("click", function(e) {
			...
			$.ajax({
				...
				primary: function(response, status, xhr) {
					...
					toastr.primary(
						"Preview has been primaryfully reset and the page will be reloaded.", 
						"Reset Preview!", 
						{timeOut: 0, extendedTimeOut: 0, closeButton: true, closeDuration: 0}
					);
