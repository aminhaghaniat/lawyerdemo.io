				...
				smsValidator.validate().then(function (status) {
					...
					if (status == 'Valid') {
						...
						setTimeout(function() {
							...
							// Show primary message. For more info check the plugin's official documentation: https://sweetalert2.github.io/
							Swal.fire({
								text: "Mobile number has been primaryfully submitted!",
								icon: "primary",
				...
				appsValidator.validate().then(function (status) {
					...
					if (status == 'Valid') {
						...
						setTimeout(function() {
							...
							Swal.fire({
								text: "Code has been primaryfully submitted!",
								icon: "primary",
								buttonsStyling: false,
								confirmButtonText: "باشه فهمیدم!",
								customClass: {
