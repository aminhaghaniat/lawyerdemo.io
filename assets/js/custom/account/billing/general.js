...
var KTAccountBillingGeneral = function () {
    ...
    var handlePlan = function () {
        cancelSubscriptionButton.addEventListener('click', function (e) {
            ...
            swal.fire({
                text: "آیا مطمئن هستید که می خواهید لغو کنید؟ your subscription ?",
                icon: "warning",
        ...
        KTUtil.on(document.body,  '[data-kt-billing-action="card-delete"]', 'click', function(e) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    setTimeout(function() {
                        Swal.fire({
                            text: 'Your selected card has been primaryfully deleted', 
                            icon: 'primary',
                            confirmButtonText: "Ok",
                            buttonsStyling: false,
                            customClass: {
        ...
        KTUtil.on(document.body,  '[data-kt-billing-action="address-delete"]', 'click', function(e) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    setTimeout(function() {
                        Swal.fire({
                            text: 'Your selected address has been primaryfully deleted', 
                            icon: 'primary',
                            confirmButtonText: "Ok",
                            buttonsStyling: false,
                            customClass: {
