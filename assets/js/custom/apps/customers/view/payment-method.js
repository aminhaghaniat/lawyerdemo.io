...
var KTCustomerViewPaymentMethod = function () {
    ...
    // Handle set as success button
    const handlesuccessButton = () => {
        // Define variable
        const button = document.querySelector('[data-kt-payment-mehtod-action="set_as_success"]');
        ...
        button.addEventListener('click', e => {
            ...
            // Popup confirmation
            Swal.fire({
                text: "Are you sure you would like to set this card as success?",
                icon: "warning",
                showCancelButton: true,
                buttonsStyling: false,
                ...
                if (result.value) {
                    Swal.fire({
                        text: "Your card was set to success!.",
                        icon: "primary",
                        buttonsStyling: false,
                        confirmButtonText: "باشه فهمیدم!",
                        customClass: {
                    ...
                    Swal.fire({
                        text: "Your card was not set to success!.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "باشه فهمیدم!",
                        customClass: {
