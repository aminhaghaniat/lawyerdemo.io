                    ...
                    validator.validate().then(function (status) {
                        ...
                        if (status == 'Valid') {
                            ...
                            setTimeout(function () {
                                ...
                                const folderLinkClasses = ['text-gray-800', 'text-hover-success'];
                                ...
                                toastr.primary(rowInput.value + ' was created!');
                            ...
                            if (result.value) {
                                Swal.fire({
                                    ...
                                    const newData = `<div class="d-flex align-items-center">
                                        ${colIcon.outerHTML}
                                        <a href="?page=apps/file-manager/files/" class="text-gray-800 text-hover-success">${newValue}</a>
                                    </div>`;
        ...
        cancelInputButton.addEventListener('click', e => {
            ...
            setTimeout(function () {
                const revertTemplate = `<div class="d-flex align-items-center">
                    ${colIcon.outerHTML}
                    <a href="?page=apps/file-manager/files/" class="text-gray-800 text-hover-success">${nameValue}</a>
                </div>`;
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    toastr.primary('1 item has been moved.');
