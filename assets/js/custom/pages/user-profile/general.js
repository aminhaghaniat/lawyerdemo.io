    ...
    var handleUFollow = function() {
        ...
        followBtn.addEventListener('click', function(e){
            ...
            if (followBtn.classList.contains("btn-primary")) {
                    ...
                    followBtn.querySelector(".indicator-label").innerHTML ='دنبال کردن';
                    ...
                    followBtn.querySelector(".indicator-label").innerHTML = 'دنبال شده';
                    followBtn.disabled = false;
                }, 1000);   
            }        
        });        
    ...
    var handleFollowers = function() {
        KTUtil.on(document.body,  '[data-kt-follow-btn="true"]', 'click', function(e) {
            ...
            setTimeout(function() {
                ...
                if (el.classList.contains("btn-light-success")) { // following
