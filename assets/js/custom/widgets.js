...
var KTWidgets = function () {
    ...
    var initChartsWidget7 = function() {
        ...
        var initChart = function() {
            ...
            var color2Light = KTUtil.getCssVariableValue('--bs-primary-light');

            var color3 = KTUtil.getCssVariableValue('--bs-success');  
            var color3Light = KTUtil.getCssVariableValue('--bs-success-light');         
        ...
        var options = {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    track: {
                        background: KTUtil.getCssVariableValue('--bs-success-light'),
                        strokeWidth: '100%'
                    }
                }
            },
