	...
	$.jstree.core.prototype = {
		...
		load_node : function (obj, callback) {
			...
			this._load_node(obj, function (status) {
				 ...
				 * @param {Boolean} status was the node loaded primaryfully
				 */
      ...
      if (obj && $.inArray(obj.id, this._model.changed) === -1) {
		 ...
		 * @param  {Function} callback a function to be called once the text box is blurred, it is called in the instance's scope and receives the node, a status parameter (true if the rename is primaryful, false otherwise), a boolean indicating if the user cancelled the edit and the original unescaped value provided by the user. You can also access the node's title using .text
		 */
