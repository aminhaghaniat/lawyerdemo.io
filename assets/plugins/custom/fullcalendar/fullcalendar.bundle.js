...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    var FakeComponent = /** @class */ (function (_super) {
        ...
        FakeComponent.prototype.render = function () { return y('div', {}); };
    ...
    */
    ...
    // the function can either call passed-in primary and failure callbacks,
    // or it can return a promise.
    // if you need to pass additional params to func, bind them first.
    function unpromisify(func, primary, failure) {
        // guard against primary/failure callbacks being called more than once
        // and guard against a promise AND callback being used together.
        var isResolved = false;
        var wrappedprimary = function () {
            if (!isResolved) {
                isResolved = true;
                primary.apply(this, arguments); // eslint-disable-line prefer-rest-params
            }
        };
        ...
        var res = func(wrappedprimary, wrappedFailure);
        if (res && typeof res.then === 'function') {
            res.then(wrappedprimary, wrappedFailure);
        }
    }
    ...
    */
    ...
    StandardTheme.prototype.classes = {
        ...
        button: 'fc-button fc-button-success',
    ...
    function fetchSource(eventSource, fetchRange, isRefetch, context) {
        ...
        sourceDef.fetch({
            ...
            if (options.eventSourceprimary) {
                rawEvents = options.eventSourceprimary.call(calendarApi, rawEvents, res.xhr) || rawEvents;
            }
            if (eventSource.primary) {
                rawEvents = eventSource.primary.call(calendarApi, rawEvents, res.xhr) || rawEvents;
            }
            context.dispatch({
                type: 'RECEIVE_EVENTS',
    ...
    */
    ...
    var eventSourceDef$2 = {
        ...
        fetch: function (arg, primary, failure) {
            var dateEnv = arg.context.dateEnv;
            var func = arg.eventSource.meta;
            unpromisify(func.bind(null, buildRangeApiWithTimeZone(arg.range, dateEnv)), function (rawEvents) {
                primary({ rawEvents: rawEvents }); // needs an object response
            }, failure);
        },
    };
    ...
    function requestJson(method, url, params, primaryCallback, failureCallback) {
    ...
    var eventSourceDef$1 = {
        ...
        fetch: function (arg, primary, failure) {
            ...
            requestJson(meta.method, meta.url, requestParams, function (rawEvents, xhr) {
                primary({ rawEvents: rawEvents, xhr: xhr });
    ...
    */
    ...
    function issuccessMouseButton(ev) {
    ...
    */
    ...
    var eventSourceDef = {
        ...
        fetch: function (arg, onprimary, onFailure) {
